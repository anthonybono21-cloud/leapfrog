...
One npm install. 34 tools. Zero cloud dependencies.
...
- **778 tests** across 31 suites (session management, snapshot engine, network intelligence, tab management, security, stealth, humanization, page classification, harness intelligence, API intelligence, script executor, extended actions, HUD overlays, human intervention, cookie consent, domain knowledge, tracing, sidecar HTTP, bug regression, stress tests, benchmarks)
...
**3. Your agent now has 34 browser tools.** Create a session, navigate, and take a snapshot:
